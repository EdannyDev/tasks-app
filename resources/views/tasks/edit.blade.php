...
<head>
    ...
    <style>
        ...
        .form-button-update {
            background-color: #ecc94b; /* Amarillo representativo */
            color: black;
        }
        ...
        .form-button-back {
            background-color: #f56565; /* Rojo de regresar */
            color: white;
        }
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="form-container">
            <form action="{{ route('tasks.update', $task->id) }}" method="POST">
                ...
                <p class="form-text">Estado actual: <strong>{{ $task->is_completed ? 'Finalizada' : 'Pendiente' }}</strong></p>

                <div class="flex justify-between mt-4">
                    <button type="submit" class="form-button-update">
                        <i class="fas fa-save"></i>
                        Actualizar
                    </button>
                    <a href="{{ route('tasks.index') }}" class="form-button-back">
